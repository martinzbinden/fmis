...
export default function Modal({
  ...
  return (
    <div
      // z-[2000]: höher als Leaflets eigene Stacking-Kontexte (Controls/
      // Toolbar bis z-index 1000, siehe components/PaddockMap.tsx) — sonst
      // verschwindet das Modal hinter der Karte, wenn beide gleichzeitig
      // auf derselben Seite gerendert werden (Karte-Seite).
