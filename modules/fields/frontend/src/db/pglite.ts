...
/**
 * Zugriff auf das "fields"-Schema in der gemeinsamen pglite-Datenbank (siehe
 * core/frontend/src/db.ts) — für den Rest der App unverändert eine
 ...
 * (siehe schema/SYNC_API.md).
 */
export function getDb(): Promise<PGlite> {
  if (!dbPromise) {
    dbPromise = getModuleDb({
      schema: 'fields',
      legacyIdbName: 'fields',
      migrations,
