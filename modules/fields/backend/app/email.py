...
SMTP_FROM = os.environ.get("SMTP_FROM", "fields@localhost")
...
async def send_magic_link(to_email: str, link: str) -> None:
    ...
    message["To"] = to_email
    message["Subject"] = "Dein Kulturen-Login-Link"
    message.set_content(
        "Hallo\n\n"
        "Mit diesem Link kannst du dich im Kulturen-Modul anmelden. Der Link "
